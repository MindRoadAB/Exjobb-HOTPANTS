...
int main(int argc,char *argv[]) {
    clock_t p2, p3, p4, p5, p6, p6i1, p6i2, p7, p7i1, p7i2, p8, p9, p10, p11, p12, p13, p13i1, p13i2, p14, p15, p16;
    clock_t p1 = clock();
    ...
    for (i = 0; i < nR; i++) {
        ...
        */
        ...
        if (!(kernelImIn)) {
            ...
            */
            ...
            /* initialize kernel weight mask: kernel_vec */
             p4 = clock();
            printf("SSS took %ds %dms\n", (p4 - p3) / CLOCKS_PER_SEC, ((p4 - p3) * 1000 / CLOCKS_PER_SEC) % 1000);
             p5 = clock(); 
            ...
            if (!(strncmp(forceConvolve, "t", 1)==0)) {
                ...
                for (k = 0; k < niS; k++) {
                 ...
                 p6 = clock();
                printf("CMV took %ds %dms\n", (p6 - p6i2 + p6i1) / CLOCKS_PER_SEC, ((p6 - p6i2 + p6i1) * 1000 / CLOCKS_PER_SEC) % 1000);
                 p7i2 = clock();
                if ((strncmp(forceConvolve, "b", 1)==0)) {
        ...
        if ( (strncmp(forceConvolve, "t", 1)==0) ||
         ...
         p8 = clock();
        printf("CD took %ds %dms\n", (p8 - p7i2 + p7i1) / CLOCKS_PER_SEC, ((p8 - p7i2 + p7i1) * 1000 / CLOCKS_PER_SEC) % 1000);
         p9 = clock();
        ...
        if (convTmpl) {
            ...
            if (!(kernelImIn))
             ...
             p10 = clock();
            printf("KSC took %ds %dms\n", (p10 - p9) / CLOCKS_PER_SEC,((p10 - p9) * 1000 / CLOCKS_PER_SEC) % 1000); 
             p11 = clock();
            ...
            for (l = hwKernel; l < rPixY - hwKernel; l++) 
             ...
             p12 = clock();
            printf("conv took %ds %dms\n", (p12 - p11) / CLOCKS_PER_SEC, ((p12 - p11) * 1000 / CLOCKS_PER_SEC) % 1000); 
             p13 = clock();
        ...
        */
        ...
        if (convTmpl) {
            ...
            p14 = clock();
            printf("Sub took %ds %dms\n", (p14 - p13i2 + p13i1 - p13) / CLOCKS_PER_SEC, ((p14 - p13i2 + p13i1 - p13) * 1000 / CLOCKS_PER_SEC) % 1000);
            p15 = clock();
            ...
            for (l = hwKernel; l < rPixY - hwKernel; l++) {
               ...
               p14 = clock();
  printf("Sub took %ds %dms\n", (p14 - p13i2 + p13i1 - p13) / CLOCKS_PER_SEC,
         ((p14 - p13i2 + p13i1 - p13) * 1000 / CLOCKS_PER_SEC) % 1000);
            p15 = clock();
            /* get SSSIG and SSSCAT from final kernel solution! */
            if (!(kernelImIn)) {
                if (strncmp(figMerit, "v", 1)==0) {
    ...
    if ((doKerInfo) || (kernelImOut)) {
        ...
        if (tunit) free(tunit);
         ...
         p16 = clock();
  printf("Fin took %ds %dms\n", (p16 - p15 + p13i2 - p13i1) / CLOCKS_PER_SEC,
         ((p16 - p15 + p13i2 - p13i1) * 1000 / CLOCKS_PER_SEC) % 1000);
